...
public static class BaseSeedSql
{
    ...
    public static string SeedWeightCategories() =>
        ...
        VALUES
            (1, '83',  74.01,  83.00, 'm', 0, '83-m'),
            (2, '93',  83.01,  93.00, 'm', 0, '93-m'),
            (3, '63',  57.01,  63.00, 'f', 0, '63-f'),
            (4, '74',  66.01,  74.00, 'm', 1, '74-m-jr'),
            (5, '105', 93.01, 105.00, 'm', 0, '105-m');
    ...
    public static string SeedEras() =>
        ...
        VALUES
            (1, 'Historical Era', '2011-01-01', '2018-12-31', 'historical-era'),
            (2, 'Current Era',    '2019-01-01', '2099-12-31', 'current-era');
    ...
    public static string SeedEraWeightCategories() =>
        ...
        VALUES
            (1, 2, 1, '2019-01-01', '2099-12-31'),
            (2, 2, 2, '2019-01-01', '2099-12-31'),
            (3, 2, 3, '2019-01-01', '2099-12-31'),
            (4, 2, 4, '2019-01-01', '2099-12-31'),
            (5, 1, 1, '2011-01-01', '2018-12-31'),
            (6, 1, 5, '2011-01-01', '2018-12-31');
    ...
    public static string SeedBaseParticipations() =>
        ...
        VALUES
            (1, 1, 1, 80.5, 1, 1, 1, 0, 200.0, 130.0, 250.0, 580.0, 400.0, 85.5, 1),
            (2, 1, 1, 80.5, 1, 1, 2, 0, 180.0, 120.0, 230.0, 550.0, 370.0, 75.0, 2),
            (3, 1, 1, 80.5, 1, 1, 3, 0, 180.0, 120.0, 230.0, 530.0, 360.0, 78.0, 3);
    ...
    public static string SeedBaseAttempts() =>
        ...
        VALUES
            (1, 1, 1, 3, 200.0, 1, 'seed', 'seed'),
            (2, 1, 2, 3, 130.0, 1, 'seed', 'seed'),
            (3, 1, 3, 3, 250.0, 1, 'seed', 'seed');
