...
public sealed class MeetIndexTests : IDisposable
{
    ...
    public void WhenMeetsInMarch_GroupHeaderUsesIcelandicMonthName()
    {
        ...
        [
            new("nationals-2024", "Nationals 2024", "Reykjavik", new DateOnly(2024, 3, 15), "Kraftlyftingar", false, false, 0),
        ];
    ...
    public void ShowsMeetCards_WhenMeetsAreLoaded()
    {
        ...
        [
            new("nationals-2024", "Nationals 2024", "Reykjavik", new DateOnly(2024, 3, 15), "Kraftlyftingar", false, false, 0),
            new("spring-cup-2024", "Spring Cup 2024", "Akureyri", new DateOnly(2024, 4, 20), "Kraftlyftingar", false, false, 0),
        ];
        RegisterHttpClient(meets);
