...
namespace KRAFT.Results.WebApi.Migrations
{
    ...
    [Migration("20260518210011_AddTeamTitleShortUniqueIndex")]
    partial class AddTeamTitleShortUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KRAFT.Results.WebApi.Features.Records.Record", b =>
                {
                    ...
                    b.HasIndex(new[] { "EraId", "AgeCategoryId", "WeightCategoryId", "RecordCategoryId", "IsRaw", "IsStandard", "Date" }, "IX_Records_Slot");
