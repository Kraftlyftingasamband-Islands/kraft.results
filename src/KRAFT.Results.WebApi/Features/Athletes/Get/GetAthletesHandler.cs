...
internal sealed class GetAthletesHandler
{
    ...
    private sealed record AthleteRow(string? Slug, string Name, int? YearOfBirth, DateOnly? DateOfBirth, string Gender, int ParticipationCount, string? Club);
}
