        ...
        var row = await dbContext.Set<Meet>()
            ...
            .SelectMany(meet => meet.Participations
                ...
                .Select(p => new
                {
                    ...
                    Club = p.Club != null ? p.Club.TitleShort : string.Empty,
                    ClubSlug = p.Club != null ? p.Club.Slug : string.Empty,
                    ClubLogoImageFilename = p.Club != null ? p.Club.LogoImageFilename : null,
